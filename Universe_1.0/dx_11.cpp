...
//#endif
	...
	// Create resource format representation
	...
	ZeroMemory(&viewProjectionConstantBufferDesc, sizeof(viewProjectionConstantBufferDesc));
	viewProjectionConstantBufferDesc.Usage = D3D11_USAGE_DEFAULT;
	viewProjectionConstantBufferDesc.ByteWidth = sizeof(ConstantBuffer);
